...
$consulta=mysql_query("SELECT
  ...
  $pdf->Cell(60, 6, 'Descripcion', 1, 0, 'L', 1);
  $pdf->Cell(40, 6, 'Medicamento', 1, 0, 'L', 1);
...
$pdf->SetFont('Arial', '', 12);
  while ($row = mysql_fetch_array($consulta)) {
     $pdf->Cell(1,1);
     $pdf->Cell(65,6,utf8_encode($row[1]),1,0,'L');
    $pdf->Cell(65,6,utf8_encode($row[2]),1,0,'L');
    $pdf->Cell(60,6,utf8_encode($row[3]),1,0,'L');
    $pdf->Cell(40,6,utf8_encode($row[4]),1,0,'L');
    $pdf->Cell(20,6,utf8_encode($row[5]),1,0,'L');
    $pdf->Cell(25,6,utf8_encode($row[6]),1,1,'L');
