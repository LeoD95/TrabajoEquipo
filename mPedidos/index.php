				    ...
				    <div class="container-fluid">
				        <section id="alta" style="display: none">
            				<form id="frmAlta">
								<div class="row">
									<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
										<div class="form-group">
											<label for="idMedicamento">Seleccione el medicamento:</label>
									...
									<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
									<div class="form-group">
											<label for="idSucursal">Seleccione la sucursal:</label>
											<select  id="idSucursal" class="select2 form-control " style="width: 100%">
											</select>
										</div>
									</div>
									<hr class="linea">
								...
								<div class="row">
									<div class="col-lg-12">
										<button type="button" id="btnLista" class="btn btn-login  btn-flat  pull-left">Lista de Pedidos</button>
